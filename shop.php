  ...
  <div class="container mt-5">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="list-group mt-5">      
          ...
          <a href="shop.php?category=etc" class="list-group-item ">etc</a>
        </div>

        <!-- <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" id="list-home-list" data-bs-toggle="list" href="shop.php" role="tab" aria-controls="home">전체</a>
      <a class="list-group-item list-group-item-action" id="list-profile-list" data-bs-toggle="list" href="shop.php?category=상의" role="tab" aria-controls="profile">상의</a>
      <a class="list-group-item list-group-item-action" id="list-messages-list" data-bs-toggle="list" href="#list-messages" role="tab" aria-controls="messages">하의</a>
      <a class="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-settings" role="tab" aria-controls="settings">아우터</a>
      <a class="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-settings" role="tab" aria-controls="settings">신발</a>
      <a class="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-settings" role="tab" aria-controls="settings">etc</a>
    </div> -->
    ...
    <?php
        ...
        $row_num = mysqli_num_rows($num);//게시물 갯수 정수로 가져오기
          ...
          $sql = "SELECT * FROM goods WHERE category = '".$category."' AND for_sale = 1 order by id desc Limit $start_num,$list";
          ...
          $sql = "SELECT * FROM goods WHERE for_sale = 1 order by id desc Limit  $start_num,$list";
