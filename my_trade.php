...
<div class="container mt-5" style="width:900px;">
    ...
    <!-- row -->
    <div class="row mt-3">
        <button type="button" class="btn btn-outline-dark">내 상품</button>
    </div>
    <!-- /row -->
    ...
    <div class="row mt-5">
        ...
        <ul class="History__Category-sc-13ngiq1-1 blmFNu mt-3">
            <li class="">
            <button type="button" data-index="0">구매</button></li>
            <li class="selected"><button type="button" data-index="1">판매</button></li>
            <li class="line" role="presentation"></li>
        </ul>


        <div class="container mt-2">
        <button class="status">전체</button>
        <button class="status">진행중</button>
