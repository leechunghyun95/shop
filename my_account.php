  ...
  <?php
            ...
            <form action="mod_account.php" method="post">
                <div class="container mt-5" style="width:30%">
                  ...
                  <input class="underline" name = "nick_name" style="border-left-width:0; border-right-width:0; border-top-width:0; border-bottom-width:1;" value="<?= $row2[nick_name]?>" required>
                    
                  <!-- <div class="row mt-3 ml-1">
                    전화번호
                  </div>
                  <input class="underline" name = "phone_num" style="border-left-width:0; border-right-width:0; border-top-width:0; border-bottom-width:1;" value="<?= $row2[phone_num]?>" required>
                     -->
                  <div class="row mt-3 ml-1">
                    비밀번호
                  </div>
                  <input class="underline" type="password" name = "pw" style="border-left-width:0; border-right-width:0; border-top-width:0; border-bottom-width:1;" value="<?= $row2[pw]?>" required>
                ...
                <div class="container mt-3" style="width: 20%">
                  ...
                  <button type="button" class="btn btn-danger mt-3 mb-5" onClick="location.href='delete_user.php'">회원 탈퇴</button>
                </div>
